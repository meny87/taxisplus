...
<form role="form" name="form" action="" method="post">
    ...
    <div>
        ...
        <input type="telmovil" name="telmovil" id="telmovil" value=${form.telmovil} required autofocus/>
    </div>
    <div>
        <label for="placasID">Placas</label>
        <input type="placasID" name="placasID" id="placasID" value=${form.placasID}  required/>
    </div>
        <div>
